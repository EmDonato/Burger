...
bool stm32_nucleo_f303re_driver__msg__wheel_pwm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stm32_nucleo_f303re_driver.msg._wheel_pwm.WheelPwm", full_classname_dest, 50) == 0);
  }
  stm32_nucleo_f303re_driver__msg__WheelPwm * ros_message = _ros_message;
  {  // header
  ...
  {  // pwm
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->pwm.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'pwm'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of WheelPwm */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("stm32_nucleo_f303re_driver.msg._wheel_pwm");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WheelPwm");
  ...
  {  // pwm
    ...
    if (ros_message->pwm.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->pwm.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->pwm.size * sizeof(int32_t));
      assert(data != NULL);
